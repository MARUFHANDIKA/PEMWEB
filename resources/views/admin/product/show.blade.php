        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4 text-center">
                    <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="img-fluid rounded shadow-sm mb-3">
                ...
                <div class="col-md-8">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <i class="fa-solid fa-money-bill me-2"></i> Rp. {{ number_format($product->price, 0, ',', '.') }}
                        </li>
                        <li class="list-group-item">
