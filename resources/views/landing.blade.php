...
<section class="about container" style="padding: 50px 0;">
  ...
  <div class="about-content" style="display: flex; align-items: center; flex-wrap: wrap; gap: 30px;">
    <div class="about-text" style="flex: 1;">
      ...
      kelezatan mie ayam tradisional dengan sentuhan modern berupa ayam bakar utuh. Selain harga bersahabat, pilihan varian
...
<section class="menu-favorit" id="menu" style="padding: 50px 0; background-color: #f9f9f9;">
  <div class="container">
    ...
    <div class="menu-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px; margin-top: 30px;">
