                ...
                <table class="table table-bordered align-middle mb-0" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr data-order-id="{{ $c->id }}">
                            <td><img src="{{ asset('storage/' . ($c->product->image ?? 'default.jpg')) }}" class="img-thumbnail" style="width: 80px;"></td>
                            ...
                            <td>
                                <div class="input-group input-group-sm justify-content-center">
                                    ...
                                    <input type="text" class="form-control text-center mx-1 qty" value="{{ $c->quantity }}">
                            ...
                            <td class="text-center"><button class="btn btn-sm btn-danger btnRemove"><i class="fa fa-times"></i></button></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
